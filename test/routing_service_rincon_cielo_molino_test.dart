...
void main() {
  test('calculateRoute Rincon cielo to Molino with user level novice',
      () async {
  ...
  test('calculateRoute Rincon cielo to Molino with user level intermediate',
      () async {
    await testCalculateRoute(RunType.intermediate);
  });

  test('calculateRoute Rincon cielo to Molino with user level advanced',
      () async {
